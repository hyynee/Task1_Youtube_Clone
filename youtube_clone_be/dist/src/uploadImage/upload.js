...
let UploadController = class UploadController {
    ...
    async handleVideoUpload(file) {
        if (!file) {
            throw new common_1.HttpException('No video uploaded', common_1.HttpStatus.BAD_REQUEST);
        }
        if (!file.mimetype.startsWith('video/')) {
            throw new common_1.HttpException('File must be a video', common_1.HttpStatus.BAD_REQUEST);
        }
        const uploadPromise = new Promise((resolve, reject) => {
        ...
        try {
            ...
            throw new common_1.HttpException('Video upload failed', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UploadController.prototype, "uploadPublicFile", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
